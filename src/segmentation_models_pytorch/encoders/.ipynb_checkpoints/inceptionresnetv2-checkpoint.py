...
from src.pretrainedmodels.models.inceptionresnetv2 import InceptionResNetV2
from src.pretrainedmodels.models.inceptionresnetv2 import pretrained_settings
